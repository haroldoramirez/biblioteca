...
public class ArtigoFormData {
    ...
    public ArtigoFormData() {}

    public ArtigoFormData(String titulo, String resumo, Idioma idioma, String autores, String palavraChave, String url) {
        this.titulo = titulo;
        this.resumo = resumo;
