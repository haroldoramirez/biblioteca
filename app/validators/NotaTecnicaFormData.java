...
public class NotaTecnicaFormData {
     ...
     *				 		     CONSTRUCTORS
     *-------------------------------------------------------------------*/
    public NotaTecnicaFormData() {}

    public NotaTecnicaFormData(String titulo, String resumo, String url, Idioma idioma, String autor, String ano, String palavraChave) {
        this.titulo = titulo;
        this.resumo = resumo;
        this.url = url;
